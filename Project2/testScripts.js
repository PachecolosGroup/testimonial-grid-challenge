...
function clearAll(){
    ...
    const jokeContainer = document.querySelector('.memeJokes');
    const quoteContainer = document.querySelector('.quoteDiv');
    const riddleContainer = document.querySelector('.memeRiddle');
...
/* Test function del show meme BUENO*/
function showMeme(){
...
/* Test function del show jokes - Bueno*/
function showJoke(){
    ...
    document.querySelector('.memeJokes').appendChild(newP);
}
/* Test function del show Quotes Bueno*/
function showQuote(){
    ...
    const container =  document.querySelector('.quoteDiv');
...
function showRiddle(){
    ...
    const { question, answer } = randomRiddle; 
     const questionElemen = document.createElement('p');
     questionElemen.textContent = question; 

     const answerElemen = document.createElement('p');
     answerElemen.textContent = 'The answer is: ' + answer; 
     answerElemen.setAttribute('id', 'riddleAnswer');
     answerElemen.hidden = true;

     const container = document.querySelector('.memeRiddle');

     clearAll(); 

     container.appendChild(questionElemen);
     container.appendChild(answerElemen);
}
...
/* Informacion detras de las variables */
